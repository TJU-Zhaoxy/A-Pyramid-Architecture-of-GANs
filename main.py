...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='D:/模式识别课程/GAN/Pyramid-GAN/Dict/', help='Directory name to save the model')
    parser.add_argument('--result_dir', type=str, default='D:/模式识别课程/GAN/Pyramid-GAN/results', help='Directory name to save the generated images')
